<%-- 
    Document   : home
    Created on : 15 Feb, 2023, 10:39:41 PM
    Author     : assar
--%>
...
<div class="background">
      ...
      <div class="dropdown">
        ...
        <ul id="nav-list" class="dropdown-menu float-right">
          <li class="nav-list-item">
            ...
            <span><a href="#HomeCall">Home</a></span>
          </li>
          <br>
          <li class="nav-list-item">
            <i class="fa-solid fa-hand-holding-hand" ></i>
            <span><a href="#DetailsCall">Petcare/Grooming</a></span>
          </li>
          <br>
          <li class="nav-list-item">
            <i class="fa-solid fa-cart-shopping"></i>
            <span><a href="#ContactCall">Products</a></span>
          </li>
          <br>
          <li class="nav-list-item">
            <i class="fa fa-users" aria-hidden="true"></i>
            <span><a href="#TeamCall">Our Team</a></span>
          </li>
          <br>
          <li class="nav-list-item">
            <i class="fa-solid fa-address-card"></i>
            <span><a href="#AboutCall">About</a></span>
          </li>
          <br>
          <li class="nav-list-item">
            <i class="fa fa-address-book" aria-hidden="true"></i>
            <span><a href="#Footer">Conatct Us</a></span>
          </li>
          <br>
        </ul>
      </div>
      
      <h4><b>Dogs Ki Chudai</b></h4>
      
      <div class="loginForm">
       <a href="new_registration.jsp" class="login-icon"><i class="fa fa-user" aria-hidden="true"></i></a>
      </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div>
             <button class="sponcer">Sponsor a Rescue Today</button>
            </div>
        </div>
    </div>
    <br>
...
<div class="colors">
  <div id="rows"class="row">
    ...
    <div id="image-of-dogs" class="col-sm-6">  
        <!-- <img src="dog.jpg" alt="" height="100%" width="100%"> -->
    </div>
  </div>
</div>
...
<div class="image-setter">
  <div class="row">
      <div class="col-sm">
          <img class="row-one" src="anurag.jpg" alt="">
          <br>
          <p class="paragrap"><b>Anurag Sarkar</b></p>
          <p class="paragrap">Computer science and </p>
              <p class="paragrap">Enginner, AEC</p>
      </div>
      <div class="col-sm">
          <img class="row-one" src="supriya.jpg" alt="">
          <br>
          <p class="paragrap"><b>Supriya Chatterjee</b></p>
          <p class="paragrap">Computer science and </p>
              <p class="paragrap">Enginner, AEC</p>
          
      </div>
      <div class="col-sm">
          <img class="row-one" src="arka.JPG" alt="">
          <br>
  ...
  <div class="row">
      <div class="col-sm">
          <img class="row-two" src="supriya.JPG" alt="">
          <br>
      ...
      <div class="col-sm">
          <img class="row-two" src="ayuush.jpg" alt="">
          <br>
  ...
  <div class="colors-name">
    <div class="row">
        <div id="last" class="col-sm-6">  
            <img src="jai.png" alt="" height="100%" width="100%">
        </div>
